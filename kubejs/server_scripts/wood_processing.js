onEvent('recipes', event => {
    ...
    wood(true, 'stem', 'endergetic', 'poise', 'endergetic:poise_stem', 'endergetic:stripped_poise_stem', 'endergetic:poise_planks', 'endergetic:poise_stairs', 'endergetic:poise_slab', 'endergetic:poise_fence', 'endergetic:poise_fence_gate', 'endergetic:poise_door', 'endergetic:poise_trapdoor', 'endergetic:poise_pressure_plate', 'endergetic:poise_bookshelf', null, 'endergetic:poise_boat', 'endergetic:vertical_poise_planks');
