onEvent('recipes', event => {
    ...
    wood(true, 'log', 'biomesoplenty', 'fir', 'biomesoplenty:fir_log', 'biomesoplenty:stripped_fir_log', 'biomesoplenty:fir_planks', 'biomesoplenty:fir_stairs', 'biomesoplenty:fir_slab', 'biomesoplenty:fir_fence', 'biomesoplenty:fir_fence_gate', 'biomesoplenty:fir_door', 'biomesoplenty:fir_trapdoor', 'biomesoplenty:fir_pressure_plate', null, null, 'biomesoplenty:fir_boat', null, 'thermal:sawdust', 'biomesoplenty:fir_sapling', 'biomesoplenty:fir_leaves');
    wood(true, 'log', 'biomesoplenty', 'redwood', 'biomesoplenty:redwood_log', 'biomesoplenty:stripped_redwood_log', 'biomesoplenty:redwood_planks', 'biomesoplenty:redwood_stairs', 'biomesoplenty:redwood_slab', 'biomesoplenty:redwood_fence', 'biomesoplenty:redwood_fence_gate', 'biomesoplenty:redwood_door', 'biomesoplenty:redwood_trapdoor', 'biomesoplenty:redwood_pressure_plate', null, null, 'biomesoplenty:redwood_boat', null, 'thermal:sawdust', 'biomesoplenty:redwood_sapling', 'biomesoplenty:redwood_leaves');
    wood(true, 'log', 'biomesoplenty', 'cherry', 'biomesoplenty:cherry_log', 'biomesoplenty:stripped_cherry_log', 'biomesoplenty:cherry_planks', 'biomesoplenty:cherry_stairs', 'biomesoplenty:cherry_slab', 'biomesoplenty:cherry_fence', 'biomesoplenty:cherry_fence_gate', 'biomesoplenty:cherry_door', 'biomesoplenty:cherry_trapdoor', 'biomesoplenty:cherry_pressure_plate', null, null, 'biomesoplenty:cherry_boat', null, 'thermal:sawdust', 'biomesoplenty:white_cherry_sapling', 'biomesoplenty:white_cherry_leaves');
    ...
    wood(true, 'log', 'biomesoplenty', 'mahogany', 'biomesoplenty:mahogany_log', 'biomesoplenty:stripped_mahogany_log', 'biomesoplenty:mahogany_planks', 'biomesoplenty:mahogany_stairs', 'biomesoplenty:mahogany_slab', 'biomesoplenty:mahogany_fence', 'biomesoplenty:mahogany_fence_gate', 'biomesoplenty:mahogany_door', 'biomesoplenty:mahogany_trapdoor', 'biomesoplenty:mahogany_pressure_plate', null, null, 'biomesoplenty:mahogany_boat', null, 'thermal:sawdust', 'biomesoplenty:mahogany_sapling', 'biomesoplenty:mahogany_leaves');
    wood(true, 'log', 'biomesoplenty', 'jacaranda', 'biomesoplenty:jacaranda_log', 'biomesoplenty:stripped_jacaranda_log', 'biomesoplenty:jacaranda_planks', 'biomesoplenty:jacaranda_stairs', 'biomesoplenty:jacaranda_slab', 'biomesoplenty:jacaranda_fence', 'biomesoplenty:jacaranda_fence_gate', 'biomesoplenty:jacaranda_door', 'biomesoplenty:jacaranda_trapdoor', 'biomesoplenty:jacaranda_pressure_plate', null, null, 'biomesoplenty:jacaranda_boat', null, 'thermal:sawdust', 'biomesoplenty:jacaranda_sapling', 'biomesoplenty:jacaranda_leaves');
    wood(true, 'log', 'biomesoplenty', 'palm', 'biomesoplenty:palm_log', 'biomesoplenty:stripped_palm_log', 'biomesoplenty:palm_planks', 'biomesoplenty:palm_stairs', 'biomesoplenty:palm_slab', 'biomesoplenty:palm_fence', 'biomesoplenty:palm_fence_gate', 'biomesoplenty:palm_door', 'biomesoplenty:palm_trapdoor', 'biomesoplenty:palm_pressure_plate', null, null, 'biomesoplenty:palm_boat', null, 'thermal:sawdust', 'biomesoplenty:palm_sapling', 'biomesoplenty:palm_leaves');
    wood(true, 'log', 'biomesoplenty', 'willow', 'biomesoplenty:willow_log', 'biomesoplenty:stripped_willow_log', 'biomesoplenty:willow_planks', 'biomesoplenty:willow_stairs', 'biomesoplenty:willow_slab', 'biomesoplenty:willow_fence', 'biomesoplenty:willow_fence_gate', 'biomesoplenty:willow_door', 'biomesoplenty:willow_trapdoor', 'biomesoplenty:willow_pressure_plate', null, null, 'biomesoplenty:willow_boat', null, 'thermal:sawdust', 'biomesoplenty:willow_sapling', 'biomesoplenty:willow_leaves');
    wood(true, 'log', 'biomesoplenty', 'dead', 'biomesoplenty:dead_log', 'biomesoplenty:stripped_dead_log', 'biomesoplenty:dead_planks', 'biomesoplenty:dead_stairs', 'biomesoplenty:dead_slab', 'biomesoplenty:dead_fence', 'biomesoplenty:dead_fence_gate', 'biomesoplenty:dead_door', 'biomesoplenty:dead_trapdoor', 'biomesoplenty:dead_pressure_plate', null, null, 'biomesoplenty:dead_boat', null, 'thermal:sawdust', 'biomesoplenty:dead_sapling', 'biomesoplenty:dead_leaves');
    wood(true, 'log', 'biomesoplenty', 'magic', 'biomesoplenty:magic_log', 'biomesoplenty:stripped_magic_log', 'biomesoplenty:magic_planks', 'biomesoplenty:magic_stairs', 'biomesoplenty:magic_slab', 'biomesoplenty:magic_fence', 'biomesoplenty:magic_fence_gate', 'biomesoplenty:magic_door', 'biomesoplenty:magic_trapdoor', 'biomesoplenty:magic_pressure_plate', null, null, 'biomesoplenty:magic_boat', null, 'thermal:sawdust', 'biomesoplenty:magic_sapling', 'biomesoplenty:magic_leaves');
    wood(true, 'log', 'biomesoplenty', 'umbran', 'biomesoplenty:umbran_log', 'biomesoplenty:stripped_umbran_log', 'biomesoplenty:umbran_planks', 'biomesoplenty:umbran_stairs', 'biomesoplenty:umbran_slab', 'biomesoplenty:umbran_fence', 'biomesoplenty:umbran_fence_gate', 'biomesoplenty:umbran_door', 'biomesoplenty:umbran_trapdoor', 'biomesoplenty:umbran_pressure_plate', null, null, 'biomesoplenty:umbran_boat', null, 'thermal:sawdust', 'biomesoplenty:umbran_sapling', 'biomesoplenty:umbran_leaves');
    wood(true, 'log', 'biomesoplenty', 'hellbark', 'biomesoplenty:hellbark_log', 'biomesoplenty:stripped_hellbark_log', 'biomesoplenty:hellbark_planks', 'biomesoplenty:hellbark_stairs', 'biomesoplenty:hellbark_slab', 'biomesoplenty:hellbark_fence', 'biomesoplenty:hellbark_fence_gate', 'biomesoplenty:hellbark_door', 'biomesoplenty:hellbark_trapdoor', 'biomesoplenty:hellbark_pressure_plate', null, null, 'biomesoplenty:hellbark_boat', null, 'thermal:sawdust', 'biomesoplenty:hellbark_sapling', 'biomesoplenty:hellbark_leaves');
