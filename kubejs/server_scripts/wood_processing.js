onEvent('recipes', event => {
    function wood(isModded, logType, modName, woodName, logItem, logStrippedItem, plankItem, stairItem, slabItem, fenceItem, gateItem, doorItem, trapdoorItem, pPlateItem, bookshelfItem, craftingTableItem, boatItem, vertPlankItem, sawdustItem) {
    ...
    wood(true, 'log', 'biomesoplenty', 'palm', 'biomesoplenty:palm_log', 'biomesoplenty:stripped_palm_log', 'biomesoplenty:palm_planks', 'biomesoplenty:palm_stairs', 'biomesoplenty:palm_slab', 'biomesoplenty:palm_fence', 'biomesoplenty:palm_fence_gate', 'biomesoplenty:palm_door', 'biomesoplenty:palm_trapdoor', 'biomesoplenty:palm_pressure_plate', 'quarkoplenty:palm_bookshelf', null, 'biomesoplenty:palm_boat', 'quarkoplenty:vertical_palm_planks', 'thermal:sawdust');
    ...
    wood(true, 'log', 'byg', 'aspen', 'byg:aspen_log', 'byg:stripped_aspen_log', 'byg:aspen_planks', 'byg:aspen_stairs', 'byg:aspen_slab', 'byg:aspen_fence', 'byg:aspen_fence_gate', 'byg:aspen_door', 'byg:aspen_trapdoor', 'byg:aspen_pressure_plate', 'byg:aspen_bookshelf', 'byg:aspen_crafting_table', 'byg:aspen_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'baobab', 'byg:baobab_log', 'byg:stripped_baobab_log', 'byg:baobab_planks', 'byg:baobab_stairs', 'byg:baobab_slab', 'byg:baobab_fence', 'byg:baobab_fence_gate', 'byg:baobab_door', 'byg:baobab_trapdoor', 'byg:baobab_pressure_plate', 'byg:baobab_bookshelf', 'byg:baobab_crafting_table', 'byg:baobab_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'blue_enchanted', 'byg:blue_enchanted_log', 'byg:stripped_blue_enchanted_log', 'byg:blue_enchanted_planks', 'byg:blue_enchanted_stairs', 'byg:blue_enchanted_slab', 'byg:blue_enchanted_fence', 'byg:blue_enchanted_fence_gate', 'byg:blue_enchanted_door', 'byg:blue_enchanted_trapdoor', 'byg:blue_enchanted_pressure_plate', 'byg:blue_enchanted_bookshelf', 'byg:blue_enchanted_crafting_table', 'byg:blue_enchanted_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'cherry', 'byg:cherry_log', 'byg:stripped_cherry_log', 'byg:cherry_planks', 'byg:cherry_stairs', 'byg:cherry_slab', 'byg:cherry_fence', 'byg:cherry_fence_gate', 'byg:cherry_door', 'byg:cherry_trapdoor', 'byg:cherry_pressure_plate', 'byg:cherry_bookshelf', 'byg:cherry_crafting_table', 'byg:cherry_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'cika', 'byg:cika_log', 'byg:stripped_cika_log', 'byg:cika_planks', 'byg:cika_stairs', 'byg:cika_slab', 'byg:cika_fence', 'byg:cika_fence_gate', 'byg:cika_door', 'byg:cika_trapdoor', 'byg:cika_pressure_plate', 'byg:cika_bookshelf', 'byg:cika_crafting_table', 'byg:cika_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'cypress', 'byg:cypress_log', 'byg:stripped_cypress_log', 'byg:cypress_planks', 'byg:cypress_stairs', 'byg:cypress_slab', 'byg:cypress_fence', 'byg:cypress_fence_gate', 'byg:cypress_door', 'byg:cypress_trapdoor', 'byg:cypress_pressure_plate', 'byg:cypress_bookshelf', 'byg:cypress_crafting_table', 'byg:cypress_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'ebony', 'byg:ebony_log', 'byg:stripped_ebony_log', 'byg:ebony_planks', 'byg:ebony_stairs', 'byg:ebony_slab', 'byg:ebony_fence', 'byg:ebony_fence_gate', 'byg:ebony_door', 'byg:ebony_trapdoor', 'byg:ebony_pressure_plate', 'byg:ebony_bookshelf', 'byg:ebony_crafting_table', 'byg:ebony_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'ether', 'byg:ether_log', 'byg:stripped_ether_log', 'byg:ether_planks', 'byg:ether_stairs', 'byg:ether_slab', 'byg:ether_fence', 'byg:ether_fence_gate', 'byg:ether_door', 'byg:ether_trapdoor', 'byg:ether_pressure_plate', 'byg:ether_bookshelf', 'byg:ether_crafting_table', null, null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'fir', 'byg:fir_log', 'byg:stripped_fir_log', 'byg:fir_planks', 'byg:fir_stairs', 'byg:fir_slab', 'byg:fir_fence', 'byg:fir_fence_gate', 'byg:fir_door', 'byg:fir_trapdoor', 'byg:fir_pressure_plate', 'byg:fir_bookshelf', 'byg:fir_crafting_table', 'byg:fir_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'green_enchanted', 'byg:green_enchanted_log', 'byg:stripped_green_enchanted_log', 'byg:green_enchanted_planks', 'byg:green_enchanted_stairs', 'byg:green_enchanted_slab', 'byg:green_enchanted_fence', 'byg:green_enchanted_fence_gate', 'byg:green_enchanted_door', 'byg:green_enchanted_trapdoor', 'byg:green_enchanted_pressure_plate', 'byg:green_enchanted_bookshelf', 'byg:green_enchanted_crafting_table', 'byg:green_enchanted_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'holly', 'byg:holly_log', 'byg:stripped_holly_log', 'byg:holly_planks', 'byg:holly_stairs', 'byg:holly_slab', 'byg:holly_fence', 'byg:holly_fence_gate', 'byg:holly_door', 'byg:holly_trapdoor', 'byg:holly_pressure_plate', 'byg:holly_bookshelf', 'byg:holly_crafting_table', 'byg:holly_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'jacaranda', 'byg:jacaranda_log', 'byg:stripped_jacaranda_log', 'byg:jacaranda_planks', 'byg:jacaranda_stairs', 'byg:jacaranda_slab', 'byg:jacaranda_fence', 'byg:jacaranda_fence_gate', 'byg:jacaranda_door', 'byg:jacaranda_trapdoor', 'byg:jacaranda_pressure_plate', 'byg:jacaranda_bookshelf', 'byg:jacaranda_crafting_table', 'byg:jacaranda_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'lament', 'byg:lament_log', 'byg:stripped_lament_log', 'byg:lament_planks', 'byg:lament_stairs', 'byg:lament_slab', 'byg:lament_fence', 'byg:lament_fence_gate', 'byg:lament_door', 'byg:lament_trapdoor', 'byg:lament_pressure_plate', 'byg:lament_bookshelf', 'byg:lament_crafting_table', null, null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'mahogany', 'byg:mahogany_log', 'byg:stripped_mahogany_log', 'byg:mahogany_planks', 'byg:mahogany_stairs', 'byg:mahogany_slab', 'byg:mahogany_fence', 'byg:mahogany_fence_gate', 'byg:mahogany_door', 'byg:mahogany_trapdoor', 'byg:mahogany_pressure_plate', 'byg:mahogany_bookshelf', 'byg:mahogany_crafting_table', 'byg:mahogany_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'mangrove', 'byg:mangrove_log', 'byg:stripped_mangrove_log', 'byg:mangrove_planks', 'byg:mangrove_stairs', 'byg:mangrove_slab', 'byg:mangrove_fence', 'byg:mangrove_fence_gate', 'byg:mangrove_door', 'byg:mangrove_trapdoor', 'byg:mangrove_pressure_plate', 'byg:mangrove_bookshelf', 'byg:mangrove_crafting_table', 'byg:mangrove_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'maple', 'byg:maple_log', 'byg:stripped_maple_log', 'byg:maple_planks', 'byg:maple_stairs', 'byg:maple_slab', 'byg:maple_fence', 'byg:maple_fence_gate', 'byg:maple_door', 'byg:maple_trapdoor', 'byg:maple_pressure_plate', 'byg:maple_bookshelf', 'byg:maple_crafting_table', 'byg:maple_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'nightshade', 'byg:nightshade_log', 'byg:stripped_nightshade_log', 'byg:nightshade_planks', 'byg:nightshade_stairs', 'byg:nightshade_slab', 'byg:nightshade_fence', 'byg:nightshade_fence_gate', 'byg:nightshade_door', 'byg:nightshade_trapdoor', 'byg:nightshade_pressure_plate', 'byg:nightshade_bookshelf', 'byg:nightshade_crafting_table', null, null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'palm', 'byg:palm_log', 'byg:stripped_palm_log', 'byg:palm_planks', 'byg:palm_stairs', 'byg:palm_slab', 'byg:palm_fence', 'byg:palm_fence_gate', 'byg:palm_door', 'byg:palm_trapdoor', 'byg:palm_pressure_plate', 'byg:palm_bookshelf', 'byg:palm_crafting_table', 'byg:palm_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'pine', 'byg:pine_log', 'byg:stripped_pine_log', 'byg:pine_planks', 'byg:pine_stairs', 'byg:pine_slab', 'byg:pine_fence', 'byg:pine_fence_gate', 'byg:pine_door', 'byg:pine_trapdoor', 'byg:pine_pressure_plate', 'byg:pine_bookshelf', 'byg:pine_crafting_table', 'byg:pine_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'rainbow_eucalyptus', 'byg:rainbow_eucalyptus_log', 'byg:stripped_rainbow_eucalyptus_log', 'byg:rainbow_eucalyptus_planks', 'byg:rainbow_eucalyptus_stairs', 'byg:rainbow_eucalyptus_slab', 'byg:rainbow_eucalyptus_fence', 'byg:rainbow_eucalyptus_fence_gate', 'byg:rainbow_eucalyptus_door', 'byg:rainbow_eucalyptus_trapdoor', 'byg:rainbow_eucalyptus_pressure_plate', 'byg:rainbow_eucalyptus_bookshelf', 'byg:rainbow_eucalyptus_crafting_table', 'byg:rainbow_eucalyptus_boat', null, 'thermal:sawdust');
    ...
    wood(true, 'log', 'byg', 'skyris', 'byg:skyris_log', 'byg:stripped_skyris_log', 'byg:skyris_planks', 'byg:skyris_stairs', 'byg:skyris_slab', 'byg:skyris_fence', 'byg:skyris_fence_gate', 'byg:skyris_door', 'byg:skyris_trapdoor', 'byg:skyris_pressure_plate', 'byg:skyris_bookshelf', 'byg:skyris_crafting_table', 'byg:skyris_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'willow', 'byg:willow_log', 'byg:stripped_willow_log', 'byg:willow_planks', 'byg:willow_stairs', 'byg:willow_slab', 'byg:willow_fence', 'byg:willow_fence_gate', 'byg:willow_door', 'byg:willow_trapdoor', 'byg:willow_pressure_plate', 'byg:willow_bookshelf', 'byg:willow_crafting_table', 'byg:willow_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'witch_hazel', 'byg:witch_hazel_log', 'byg:stripped_witch_hazel_log', 'byg:witch_hazel_planks', 'byg:witch_hazel_stairs', 'byg:witch_hazel_slab', 'byg:witch_hazel_fence', 'byg:witch_hazel_fence_gate', 'byg:witch_hazel_door', 'byg:witch_hazel_trapdoor', 'byg:witch_hazel_pressure_plate', 'byg:witch_hazel_bookshelf', 'byg:witch_hazel_crafting_table', 'byg:witch_hazel_boat', null, 'thermal:sawdust');
    wood(true, 'log', 'byg', 'zelkova', 'byg:zelkova_log', 'byg:stripped_zelkova_log', 'byg:zelkova_planks', 'byg:zelkova_stairs', 'byg:zelkova_slab', 'byg:zelkova_fence', 'byg:zelkova_fence_gate', 'byg:zelkova_door', 'byg:zelkova_trapdoor', 'byg:zelkova_pressure_plate', 'byg:zelkova_bookshelf', 'byg:zelkova_crafting_table', 'byg:zelkova_boat', null, 'thermal:sawdust');
    wood(true, 'stem', 'byg', 'bulbis', 'byg:bulbis_stem', 'byg:stripped_bulbis_stem', 'byg:bulbis_planks', 'byg:bulbis_stairs', 'byg:bulbis_slab', 'byg:bulbis_fence', 'byg:bulbis_fence_gate', 'byg:bulbis_door', 'byg:bulbis_trapdoor', 'byg:bulbis_pressure_plate', 'byg:bulbis_bookshelf', 'byg:bulbis_crafting_table', null, null, 'thermal:sawdust');
    wood(true, 'stem', 'byg', 'sythian', 'byg:sythian_stem', 'byg:stripped_sythian_stem', 'byg:sythian_planks', 'byg:sythian_stairs', 'byg:sythian_slab', 'byg:sythian_fence', 'byg:sythian_fence_gate', 'byg:sythian_door', 'byg:sythian_trapdoor', 'byg:sythian_pressure_plate', 'byg:sythian_bookshelf', 'byg:sythian_crafting_table', null, null, 'thermal:sawdust');
    wood(true, 'pedu', 'byg', 'embur', 'byg:embur_pedu', 'byg:stripped_embur_pedu', 'byg:embur_planks', 'byg:embur_stairs', 'byg:embur_slab', 'byg:embur_fence', 'byg:embur_fence_gate', 'byg:embur_door', 'byg:embur_trapdoor', 'byg:embur_pressure_plate', 'byg:embur_bookshelf', 'byg:embur_crafting_table', null, null, 'thermal:sawdust');

    wood(true, 'log', 'tconstruct', 'skyroot', 'tconstruct:skyroot_log', 'tconstruct:stripped_skyroot_log', 'tconstruct:skyroot_planks', 'tconstruct:skyroot_planks_stairs', 'tconstruct:skyroot_planks_slab', 'tconstruct:skyroot_fence', 'tconstruct:skyroot_fence_gate', 'tconstruct:skyroot_door', 'tconstruct:skyroot_trapdoor', 'tconstruct:skyroot_pressure_plate', null, null, null, null, 'superpackutils:azure_sawdust');
    wood(true, 'log', 'tconstruct', 'bloodshroom', 'tconstruct:bloodshroom_log', 'tconstruct:stripped_bloodshroom_log', 'tconstruct:bloodshroom_planks', 'tconstruct:bloodshroom_planks_stairs', 'tconstruct:bloodshroom_planks_slab', 'tconstruct:bloodshroom_fence', 'tconstruct:bloodshroom_fence_gate', 'tconstruct:bloodshroom_door', 'tconstruct:bloodshroom_trapdoor', 'tconstruct:bloodshroom_pressure_plate', null, null, null, null, 'superpackutils:bloody_sawdust');
    wood(true, 'log', 'tconstruct', 'greenheart', 'tconstruct:greenheart_log', 'tconstruct:stripped_greenheart_log', 'tconstruct:greenheart_planks', 'tconstruct:greenheart_planks_stairs', 'tconstruct:greenheart_planks_slab', 'tconstruct:greenheart_fence', 'tconstruct:greenheart_fence_gate', 'tconstruct:greenheart_door', 'tconstruct:greenheart_trapdoor', 'tconstruct:greenheart_pressure_plate', null, null, null, null, 'superpackutils:grassy_sawdust');
