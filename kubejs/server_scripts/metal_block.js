...
events.listen('recipes', function (event) { 
    ...
    event.custom({"type": "minecraft:stonecutting","ingredient": {"tag": "forge:storage_blocks/copper"},"result": "tconstruct:copper_block","count": 1})
    event.custom({"type": "minecraft:stonecutting","ingredient": {"tag": "forge:storage_blocks/copper"},"result": "libvulpes:blockcopper","count": 1})

    //Tin
    event.custom({"type": "minecraft:stonecutting","ingredient": {"tag": "forge:storage_blocks/tin"},"result": "thermal:tin_block","count": 1})
    event.custom({"type": "minecraft:stonecutting","ingredient": {"tag": "forge:storage_blocks/tin"},"result": "mekanism:block_tin","count": 1})
    event.custom({"type": "minecraft:stonecutting","ingredient": {"tag": "forge:storage_blocks/tin"},"result": "libvulpes:blocktin","count": 1})
    ...
    event.custom({"type": "minecraft:stonecutting","ingredient": {"tag": "forge:storage_blocks/aluminum"},"result": "libvulpes:blockaluminum","count": 1})

    //Nickel
    event.custom({"type": "minecraft:stonecutting","ingredient": {"tag": "forge:storage_blocks/nickel"},"result": "thermal:nickel_block","count": 1})
    event.custom({"type": "minecraft:stonecutting","ingredient": {"tag": "forge:storage_blocks/nickel"},"result": "immersiveengineering:storage_nickel","count": 1})
    ...
    event.custom({"type": "minecraft:stonecutting","ingredient": {"tag": "forge:storage_blocks/electrum"},"result": "thermal:electrum_block","count": 1})

    //Bronze
    event.custom({"type": "minecraft:stonecutting","ingredient": {"tag": "forge:storage_blocks/bronze"},"result": "mekanism:block_bronze","count": 1})
    event.custom({"type": "minecraft:stonecutting","ingredient": {"tag": "forge:storage_blocks/bronze"},"result": "thermal:bronze_block","count": 1})

    //Steel
    event.custom({"type": "minecraft:stonecutting","ingredient": {"tag": "forge:storage_blocks/steel"},"result": "mekanism:block_steel","count": 1})
    event.custom({"type": "minecraft:stonecutting","ingredient": {"tag": "forge:storage_blocks/steel"},"result": "libvulpes:blocksteel","count": 1})
    event.custom({"type": "minecraft:stonecutting","ingredient": {"tag": "forge:storage_blocks/steel"},"result": "immersiveengineering:storage_steel","count": 1})
