...
onEvent('recipes', event => {
  ...
  unifyOre(true, false, 'cobalt', 'superpackutils:raw_cobalt', 'superpackutils:purified_raw_cobalt', 'tconstruct:cobalt_ingot', 'superpackutils:cobalt_dust', null, 'tconstruct:cobalt_block', 'tconstruct:cobalt_nugget', null, null, null, 'superpackutils:crushed_cobalt_ore', null, null, 'tconstruct:molten_cobalt', 194, 65, 22, 0, 0.15, 'thermal:iron_dust', 'superpackutils:tiny_iron_dust', 2, null, 'exnihilosequentia:piece_cobalt', null, null, null, 'superpackutils:alchemical_cobalt_dust', 'superpackutils:alchemical_cobalt', null, null, 'exnihilosequentia:chunk_cobalt', 'superpackutils:purified_crushed_cobalt_ore', 'superpackutils:tiny_cobalt_dust', null);  
